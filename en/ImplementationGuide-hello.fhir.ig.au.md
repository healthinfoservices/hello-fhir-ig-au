# Resource Template FHIR Implementation Guide in Australian Context
...
```json
{
  ...
  "id" : "hello.fhir.ig.au",
  "language" : "en",
  "url" : "https://healthinfoservices.net/hello-fhir-ig-au/ImplementationGuide/hello.fhir.ig.au",
  "version" : "0.1.0",
  "name" : "HelloAuFHIRIG",
  "title" : "Template FHIR Implementation Guide in Australian Context",
  "status" : "draft",
  ...
  "description" : "This Implementation Guide template has been developed to assist Australian implementers to get started with IG Authoring.",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://healthinfoservices.net/hello-fhir-ig-au/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "name" : "Condition Severity Valueset",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/MyCondition"
      },
      "name" : "MyCondition",
    ...
    "page" : {
      ...
      },
      {
        ...
        "title" : "Authoring a FHIR IG using this template",
        "generation" : "markdown"
      },
      {
        "extension" : [{
